      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 bg-card/30 backdrop-blur-sm border-y border-white/5">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { src: '/images/progress-3.jpg', label: 'El Inicio', desc: 'Mentalidad de cambio' },
              { src: '/images/progress-4.jpg', label: 'Constancia', desc: 'Primeros meses' },
              { src: '/images/progress-1.jpg', label: 'Disciplina', desc: 'Enfoque total' },
              { src: '/images/progress-2.jpg', label: 'Logro', desc: 'Versión final' },
            ].map((img, index) => (
              <div key={index} className="group relative rounded-3xl overflow-hidden aspect-[3/4] border border-white/10 shadow-2xl">
                <img 
                  src={img.src} 
                  alt={img.label}
